...
namespace wei_im{
class UserServiceImpl : public wei_im::UserService {
    public:
        ...
        virtual void UserRegister(::google::protobuf::RpcController* controller,
            const ::wei_im::UserRegisterReq* request,
            ::wei_im::UserRegisterRsp* response,
        ...
        virtual void UserLogin(::google::protobuf::RpcController* controller,
            const ::wei_im::UserLoginReq* request,
            ::wei_im::UserLoginRsp* response,
            ::google::protobuf::Closure* done){
            LOG_DEBUG("收到用户登录请求！");
            brpc::ClosureGuard rpc_guard(done);
            auto err_response = [this, response](const std::string &rid, 
        ...
        virtual void GetUserInfo(::google::protobuf::RpcController* controller,
            const ::wei_im::GetUserInfoReq* request,
            ::wei_im::GetUserInfoRsp* response,
            ::google::protobuf::Closure* done){
        ...
        virtual void GetMultiUserInfo(::google::protobuf::RpcController* controller,
            const ::wei_im::GetMultiUserInfoReq* request,
            ::wei_im::GetMultiUserInfoRsp* response,
            ::google::protobuf::Closure* done){
        ...
        virtual void SetUserAvatar(::google::protobuf::RpcController* controller,
            const ::wei_im::SetUserAvatarReq* request,
            ::wei_im::SetUserAvatarRsp* response,
            ::google::protobuf::Closure* done){
        ...
        virtual void SetUserNickname(::google::protobuf::RpcController* controller,
            const ::wei_im::SetUserNicknameReq* request,
            ::wei_im::SetUserNicknameRsp* response,
            ::google::protobuf::Closure* done){
        ...
        virtual void SetUserDescription(::google::protobuf::RpcController* controller,
            const ::wei_im::SetUserDescriptionReq* request,
            ::wei_im::SetUserDescriptionRsp* response,
            ::google::protobuf::Closure* done){
