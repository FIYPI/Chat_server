...
namespace wei_im{
class FriendServiceImpl : public wei_im::FriendService {
    public:
        FriendServiceImpl(
        ...
        virtual void GetFriendList(::google::protobuf::RpcController* controller,
            const ::wei_im::GetFriendListReq* request,
            ::wei_im::GetFriendListRsp* response,
        ...
        virtual void FriendRemove(::google::protobuf::RpcController* controller,
            const ::wei_im::FriendRemoveReq* request,
            ::wei_im::FriendRemoveRsp* response,
            ::google::protobuf::Closure* done) {
            brpc::ClosureGuard rpc_guard(done);
            //1. 定义错误回调
            auto err_response = [this, response](const std::string &rid, 
        ...
        virtual void FriendAdd(::google::protobuf::RpcController* controller,
            const ::wei_im::FriendAddReq* request,
            ::wei_im::FriendAddRsp* response,
            ::google::protobuf::Closure* done) {
            brpc::ClosureGuard rpc_guard(done);
            //1. 定义错误回调
            auto err_response = [this, response](const std::string &rid, 
        ...
        virtual void FriendAddProcess(::google::protobuf::RpcController* controller,
            const ::wei_im::FriendAddProcessReq* request,
            ::wei_im::FriendAddProcessRsp* response,
            ::google::protobuf::Closure* done) {
            brpc::ClosureGuard rpc_guard(done);
            //1. 定义错误回调
            auto err_response = [this, response](const std::string &rid, 
        ...
        virtual void FriendSearch(::google::protobuf::RpcController* controller,
            const ::wei_im::FriendSearchReq* request,
            ::wei_im::FriendSearchRsp* response,
            ::google::protobuf::Closure* done) {
            brpc::ClosureGuard rpc_guard(done);
            //1. 定义错误回调
            auto err_response = [this, response](const std::string &rid, 
        ...
        virtual void GetPendingFriendEventList(::google::protobuf::RpcController* controller,
            const ::wei_im::GetPendingFriendEventListReq* request,
            ::wei_im::GetPendingFriendEventListRsp* response,
            ::google::protobuf::Closure* done) {
            brpc::ClosureGuard rpc_guard(done);
            //1. 定义错误回调
            auto err_response = [this, response](const std::string &rid, 
        ...
        virtual void GetChatSessionList(::google::protobuf::RpcController* controller,
            const ::wei_im::GetChatSessionListReq* request,
            ::wei_im::GetChatSessionListRsp* response,
            ::google::protobuf::Closure* done) {
            brpc::ClosureGuard rpc_guard(done);
            //1. 定义错误回调
            auto err_response = [this, response](const std::string &rid, 
        ...
        virtual void ChatSessionCreate(::google::protobuf::RpcController* controller,
            const ::wei_im::ChatSessionCreateReq* request,
            ::wei_im::ChatSessionCreateRsp* response,
            ::google::protobuf::Closure* done) {
            brpc::ClosureGuard rpc_guard(done);
            //1. 定义错误回调
            auto err_response = [this, response](const std::string &rid, 
        ...
        virtual void GetChatSessionMember(::google::protobuf::RpcController* controller,
            const ::wei_im::GetChatSessionMemberReq* request,
            ::wei_im::GetChatSessionMemberRsp* response,
            ::google::protobuf::Closure* done) {
            brpc::ClosureGuard rpc_guard(done);
            //1. 定义错误回调
            auto err_response = [this, response](const std::string &rid, 
    ...
    private:
        bool GetRecentMsg(const std::string &rid, 
            ...
            wei_im::MsgStorageService_Stub stub(channel.get());
