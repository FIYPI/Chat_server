...
DEFINE_string(app_id, "7581527", "语音平台应用ID");
DEFINE_string(api_key, "TIx9cWYBuBKkY54mEHCwjudP", "语音平台API密钥");
DEFINE_string(secret_key, "0sPbvc2q7Ub4HTOAyxEo1zsyiCxDbKys", "语音平台加密密钥");
...
int main(int argc, char *argv[])
{
    ...
    wei_im::SpeechServerBuilder ssb;
