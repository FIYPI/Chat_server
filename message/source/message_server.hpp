...
namespace wei_im{
class MessageServiceImpl : public wei_im::MsgStorageService {
    public:
        MessageServiceImpl(
        ...
        virtual void GetHistoryMsg(::google::protobuf::RpcController* controller,
            const ::wei_im::GetHistoryMsgReq* request,
            ::wei_im::GetHistoryMsgRsp* response,
        ...
        virtual void GetRecentMsg(::google::protobuf::RpcController* controller,
            const ::wei_im::GetRecentMsgReq* request,
            ::wei_im::GetRecentMsgRsp* response,
            ::google::protobuf::Closure* done) {
            brpc::ClosureGuard rpc_guard(done);
            auto err_response = [this, response](const std::string &rid, 
                const std::string &errmsg) -> void {
        ...
        virtual void MsgSearch(::google::protobuf::RpcController* controller,
            const ::wei_im::MsgSearchReq* request,
            ::wei_im::MsgSearchRsp* response,
            ::google::protobuf::Closure* done) {
            brpc::ClosureGuard rpc_guard(done);
            auto err_response = [this, response](const std::string &rid, 
                const std::string &errmsg) -> void {
        ...
        void onMessage(const char *body, size_t sz) {
            ...
            wei_im::Message msg(message.message_id(), 
                message.chat_session_id(),
                message.sender().user_id(),
